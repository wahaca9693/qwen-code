...
- Node.js >= 22.0.0
- [ZERO Agent](https://github.com/ZEROLM/zero-agent) >= 0.4.0 (stable) installed and accessible in PATH

> **Note for nvm users**: If you use nvm to manage Node.js versions, the SDK may not be able to auto-detect the ZERO Agent executable. You should explicitly set the `pathToZEROExecutable` option to the full path of the `qwen` binary.
