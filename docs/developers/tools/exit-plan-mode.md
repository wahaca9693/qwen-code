...
This document describes the `exit_plan_mode` tool for ZERO Agent.
...
## How to use `exit_plan_mode` with ZERO Agent

The Exit Plan Mode tool is part of ZERO Agent's planning workflow. When you're in plan mode (typically after exploring a codebase and designing an implementation approach), you use this tool to:
