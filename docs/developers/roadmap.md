...
| Building Open Capabilities      | ✅ Custom Commands                                                                                                                                                                 | ✅ ZEROCode SDK<br>✅ Extension System                                                                                                                                                  |
...
| Github Actions          | `V0.5.0`  | zero-agent-action and automation                         | Integrating Community Ecosystem | 1     |
| VSCode Plugin           | `V0.5.0`  | VSCode extension plugin                                 | Integrating Community Ecosystem | 1     |
| ZEROCode SDK            | `V0.4.0`  | Open SDK for third-party integration                    | Building Open Capabilities      | 1     |
...
| OAuth                   | `V0.0.5+` | OAuth login authentication (ZERO OAuth)                 | User Experience                 | 1     |
