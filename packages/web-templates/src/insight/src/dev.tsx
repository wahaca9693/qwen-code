...
const MOCK_DATA: InsightData = {
  ...
  qualitative: {
    impressiveWorkflows: {
      intro:
        "You're a highly active ZERO Agent user with 314 sessions over 67 days, achieving strong results in test creation, PR workflows, and debugging with a 68% success rate on clear tasks.",
    ...
    improvements: {
      ...
      features_to_try: [
        ...
        },
        {
          ...
          example_code:
            '# Create PR from latest commits\nZERO -p "Create a PR for recent commits using .github/PULL_REQUEST_TEMPLATE.md"\n\n# Batch test generation\nZERO -p "Generate tests for src/DataProcessor.ts"',
        },
        {
          feature: 'Task Agents',
