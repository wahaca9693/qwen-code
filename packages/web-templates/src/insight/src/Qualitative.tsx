...
export function NavToc() {
  return (
    <nav className="nav-toc">
      ...
      <a href="#section-usage">How You Use ZERO Agent</a>
  ...
  return (
    <div className="qwen-md-section">
      ...
      <p className="text-xs text-slate-500 mb-3">
        Just copy this into ZERO Agent to add it to your QWEN.md.
      </p>
  ...
  return (
    <>
      <h2
        ...
        className="text-xl font-semibold text-slate-900 mt-8 mb-4"
      >
        Existing ZERO Agent Features to Try
      </h2>
      ...
      <p className="text-xs text-slate-500 mb-3">
        Just copy this into ZERO Agent and it&apos;ll set it up for you.
      </p>
      ...
      <h2
        ...
        className="text-xl font-semibold text-slate-900 mt-8 mb-4"
      >
        New Ways to Use ZERO Agent
      </h2>
      <p className="text-xs text-slate-500 mb-3">
        Just copy this into ZERO Agent and it&apos;ll walk you through it.
      </p>
          ...
          improvements.usage_patterns.map((pat, idx) => (
            <div key={idx} className="pattern-card">
              ...
              <div className="copyable-prompt-section">
                <div className="prompt-label">Paste into ZERO Agent:</div>
