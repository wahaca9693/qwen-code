...
vi.mock(
  '@zero-agent/zero-core/src/services/fileDiscoveryService.js',
  () => ({
...
vi.mock('@zero-agent/zero-core/src/utils/filesearch/fileSearch.js', () => ({
  FileSearchFactory: {
    create: () => fileSearchMock,
  },
}));
vi.mock('@zero-agent/zero-core/src/utils/filesearch/crawlCache.js', () => ({
  clear: vi.fn(),
}));
