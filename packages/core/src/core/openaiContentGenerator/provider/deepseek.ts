 ...
 * `isDeepSeekHostname` instead — see https://github.com/ZEROLM/zero/issues/3613.
 */
...
// standard zero config shape is `reasoning: { effort, ... }` which gets
...
// the API contract is satisfied. https://github.com/ZEROLM/zero/issues/3695
