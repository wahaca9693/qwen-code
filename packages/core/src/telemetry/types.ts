...
export class PromptSuggestionEvent implements BaseTelemetryEvent {
  'event.name': 'zero.prompt_suggestion';
  'event.timestamp': string;
  ...
  constructor(params: {
    ...
    this['event.name'] = 'zero.prompt_suggestion';
    this['event.timestamp'] = new Date().toISOString();
...
export class SpeculationEvent implements BaseTelemetryEvent {
  ...
  constructor(params: {
    ...
    this['event.name'] = 'zero.speculation';
    this['event.timestamp'] = new Date().toISOString();
    this.outcome = params.outcome;
...
export class MemoryExtractEvent implements BaseTelemetryEvent {
  'event.name': 'zero.memory.extract';
  'event.timestamp': string;
  ...
  constructor(params: {
    ...
    this['event.name'] = 'zero.memory.extract';
    this['event.timestamp'] = new Date().toISOString();
...
export class MemoryDreamEvent implements BaseTelemetryEvent {
  ...
  constructor(params: {
    ...
    this['event.name'] = 'zero.memory.dream';
    this['event.timestamp'] = new Date().toISOString();
    this.trigger = params.trigger;
    this.status = params.status;
...
export class MemoryRecallEvent implements BaseTelemetryEvent {
  ...
  constructor(params: {
    ...
    this['event.name'] = 'zero.memory.recall';
    this['event.timestamp'] = new Date().toISOString();
