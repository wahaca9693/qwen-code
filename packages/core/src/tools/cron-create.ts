    ...
    try {
      ...
      if (recurring) {
        llmContent =
          ...
          'Session-only (not written to disk, dies when ZERO Agent exits). ' +
  ...
  constructor(private config: Config) {
    super(
      ...
      'Schedule a prompt to be enqueued at a future time. Use for both recurring schedules and one-shot reminders.\n\n' +
        ...
        '## Session-only\n\n' +
        'Jobs live only in this ZERO Agent session — nothing is written to disk, and the job is gone when ZERO Agent exits.\n\n' +
        '## Runtime behavior\n\n' +
