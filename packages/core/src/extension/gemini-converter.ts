...
/**
 * Converter for Gemini extensions to ZERO Agent format.
 */
...
/**
 * Converts a Gemini extension config to ZERO Agent format.
...
/**
 * Converts a complete Gemini extension package to ZERO Agent format.
