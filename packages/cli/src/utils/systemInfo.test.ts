...
import { IdeClient } from '@zero-agent/zero-core';
...
describe('systemInfo', () => {
  ...
  describe('getExtendedSystemInfo', () => {
    it('should include memory usage and base URL', async () => {
      ...
      const { AuthType } = await import('@zero-agent/zero-core');
