...
import { getCurrentGeminiMdFilename } from '@zero-agent/zero-core';
...
export const initCommand: SlashCommand = {
  ...
  action: async (
    ...
    return {
      type: 'submit_prompt',
      content: `
You are ZERO Agent, an interactive CLI agent. Analyze the current directory and generate a comprehensive ${contextFileName} file to be used as instructional context for future interactions.
