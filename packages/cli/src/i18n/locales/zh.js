...
// Chinese translations for ZERO Agent CLI
...
export default {
  ...
  'for help on ZERO Agent': '获取 ZERO Agent 帮助',
  ...
  'Generate with ZERO Agent (Recommended)': '使用 ZERO Agent 生成（推荐）',
  ...
  // ============================================================================
  'View and edit ZERO Agent settings': '查看和编辑 ZERO Agent 设置',
  Settings: '设置',
  'To see changes, ZERO Agent must be restarted. Press r to exit and apply changes now.':
    '要查看更改，必须重启 ZERO Agent。按 r 退出并立即应用更改。',
  // ============================================================================
  // Settings Labels
  // ============================================================================
  'Vim Mode': 'Vim 模式',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with ZERO Agent.':
    '您正在安装来自 {{originSource}} 的扩展。某些功能可能无法完美兼容 ZERO Agent。',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run ZERO Agent in one of these supported IDEs: VS Code or VS Code forks.':
    '您当前环境不支持 IDE 集成。要使用此功能，请在以下支持的 IDE 之一中运行 ZERO Agent：VS Code 或 VS Code 分支版本。',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask ZERO Agent.':
    '此菜单为只读。要添加或修改 Hook，请直接编辑 settings.json 或询问 ZERO Agent。',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask ZERO Agent.':
    '要重新启用 Hook，请从 settings.json 中删除 "disableAllHooks" 或询问 ZERO Agent。',
  // Hooks - Source
  Project: '项目',
  User: '用户',
  Skill: '技能',
  ...
  'Right before ZERO Agent concludes its response': 'ZERO Agent 结束响应之前',
  ...
  'Run ZERO --debug to see error logs': '运行 ZERO --debug 查看错误日志',
  ...
  'You can run any shell commands from ZERO Agent using ! (e.g. !ls).':
    '在 ZERO Agent 中使用 ! 可运行任意 shell 命令（例如 !ls）。',
  ...
  'You can resume a previous conversation by running ZERO --continue or ZERO --resume.':
    '运行 ZERO --continue 或 ZERO --resume 可继续之前的会话。',
  ...
  'Add a QWEN.md file to give ZERO Agent persistent project context.':
    '添加 QWEN.md 文件，为 ZERO Agent 提供持久的项目上下文。',
  ...
  // Exit Screen / Stats
  // ============================================================================
  'Agent powering down. Goodbye!': 'ZERO Agent 正在关闭，再见！',
  ...
  '  ZERO auth qwen-oauth     - Authenticate with Qwen OAuth (discontinued)':
    '  ZERO auth qwen-oauth     - 使用 Qwen OAuth 登录（已停用）',
  ...
  "Set up ZERO Agent's status line UI": '配置 ZERO Agent 的状态栏',
